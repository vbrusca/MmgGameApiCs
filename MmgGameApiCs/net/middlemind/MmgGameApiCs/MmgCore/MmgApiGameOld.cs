...
namespace net.middlemind.MmgGameApiCs.MmgCore
{
    ...
    public class MmgApiGameOld
    {
        ...
        /// </summary>
        //public static GamePanelOld pnlGame;
        ...
        public static void ExampleMain(string[] args)
        {
            ...
            pnlGame = new GamePanelOld(mf, MmgApiGame.PANEL_WIDTH, MmgApiGame.PANEL_HEIGHT, (MmgApiGame.WIN_WIDTH - MmgApiGame.PANEL_WIDTH) / 2, (MmgApiGame.WIN_HEIGHT - MmgApiGame.PANEL_HEIGHT) / 2, MmgApiGame.GAME_WIDTH, MmgApiGame.GAME_HEIGHT);
